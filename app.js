...
function sum(a, b) {
  var sums = (a + b);
  var array1 = [sums,'The sum of ' + a + ' and ' + b + ' is ' + sums + '.'];
  return array1;
}
...
function multiplyArray(testArray) {
  var multy1 = multiply(testArray[0],testArray[1])[0];
  var multy2 = multiply(testArray[2],multy1)[0];
  var array = [multy2 ,'The numbers ' + testArray[0] + ',' + testArray[1] + ',' + testArray[2] + ' have a product of ' + multy2 +'.'];
  //console.log(multy2);
  //console.log(multy2);
